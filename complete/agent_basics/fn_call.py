...
calander_bro = ConversableAgent(
    name="calander_bro",
    system_message="Call the right function to get the user's calendar events. Make sure you call the function with the correct allowed arguments (work or personal).",
    llm_config={
